...
class Pea_Timeline extends Widget_Base {
	...
	protected function register_controls(){
      ...
      $this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'pedro-elementor-icon' ),
		...
		$this->add_control(
			'timeline_list',
			[
				'label' => esc_html__( 'Timeline', 'pedro-elementor-icon' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => [
					[
						'name'        => 'icon',
						'label'       => esc_html__( 'Icon', 'pedro-elementor-icon' ),
					...
					[
						'name'        => 'title',
						'label'       => esc_html__( 'Title', 'pedro-elementor-icon' ),
						'type'        => Controls_Manager::TEXT,
						'default'     => esc_html__( 'Title' , 'pedro-elementor-icon' ),
						'label_block' => true,
					],
					[
						'name'        => 'discription',
						'label'       => esc_html__( 'Discription', 'pedro-elementor-icon' ),
						'type'        => Controls_Manager::TEXTAREA,
						'default'     => esc_html__( 'Discription' , 'pedro-elementor-icon' ),
						'label_block' => true,
					],
					[
						'name'        => 'education_info',
						'label'       => esc_html__( 'Education Info', 'pedro-elementor-icon' ),
						'type'        => Controls_Manager::TEXTAREA,
						'default'     => esc_html__( 'Computer Science' , 'pedro-elementor-icon' ),
						'label_block' => true,
					],
				],
				'default' => [
					[
						'list_title'   => esc_html__( 'Timeline #1', 'pedro-elementor-icon' ),
						'list_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'pedro-elementor-icon' ),
					],
					[
						'list_title'   => esc_html__( 'Timeline #2', 'pedro-elementor-icon' ),
						'list_content' => esc_html__( 'Item content. Click the edit button to change this text.', 'pedro-elementor-icon' ),
					],
					[
						'list_title'   => esc_html__( 'Timeline #2', 'pedro-elementor-icon' ),
